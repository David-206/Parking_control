    ...
    <section id="banner">
        ...
        <ul class="actions">
            <div class="container-fluid ">
                    ...
                    <div class="container">
                        <label><h2 style="color: #ffffff;"><bs>Registrar Usuario</b></h2></label>
                        <br>
                        <form action="?c=Operario&m=insertEstudiante" name="formInsertSeller" id="formInsertSeller" method="post" enctype="multipart/form-data" autocomplete="off">
                            
                             
                            <div class="form-group">
                                <label for="user" style="color: #ffffff;">Nombres</label>
                                <input class="form-control"  style="color:black;" type="text" name="nombre" id="nombre" placeholder="Nombres del Usuario" size="50" required="" onchange="validar_nombres(this.value)" pattern="^[a-zA-Z áéíóúñÑÁÉÍÓÚ ]*$">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" style="color:black;" type="text" name="apellido" id="apellido" placeholder="Apellidos del Usuario" size="50" required="" onchange="validar_apellidos(this.value)" pattern="^[a-zA-Z áéíóúñÑÁÉÍÓÚ ]*$">
                                <small class="form-text text-muted" style="color: #ffffff;">Diligenciar en MAYÚSCULAS.</small>
                            </div>
                            <div class="form-group">
