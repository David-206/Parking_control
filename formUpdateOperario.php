                        ...
                        <form action="?c=Admin&m=updateOperario" name="formInsertSeller" id="formInsertSeller" method="post" enctype="multipart/form-data" autocomplete="off">
                           <input class="form-control"  style="color:black;" type="hidden" name="id" id="id" value="<?php echo $_REQUEST['id'];?>">
                            <div class="form-group">
                                ...
                                <input value="<?php echo $r->usuario_nombre;?>"class="form-control"  style="color:black;" type="text" name="nombre" id="nombre" placeholder="Nombres del Operario" size="50" required="" onchange="validar_nombres(this.value)" pattern="^[a-zA-Z áéíóúñÑÁÉÍÓÚ ]*$">
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?php echo $r->usuario_apellido;?>"class="form-control" style="color:black;" type="text" name="apellido" id="apellido" placeholder="Apellidos del Operario" size="50" required="" onchange="validar_apellidos(this.value)" pattern="^[a-zA-Z áéíóúñÑÁÉÍÓÚ ]*$">
                                <small class="form-text text-muted" style="color: #ffffff;">Diligenciar en MAYÚSCULAS.</small>
                            </div>
                            <div class="form-group">
