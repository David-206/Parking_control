                    ...
                    <div class="panel panel-default panel-table">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="panel-title">
                                        <center><h3><B>Estudiantes y Docentes</b></h3></center>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <form class="navbar-form text-left" role="search">
                                    <input class="form-control"  placeholder="Documento,Nombre o Apellido" style="width:80%; background-color: white; border: 1px solid; " name="srch-term" id="srch-term" type="text" onkeyup="queryLikeListUsuario(this.value)">
                                    </form>
                                </div> 
                        ...
                        <div class="panel-body" id="invent"   style="overflow-y: scroll; max-height: 600px;">
                            <table id="mytable" class="table table-striped table-bordered table-list" >
                                ...
                                <tbody>
                                    <?php foreach ($this->modelOperario->queryEstudiante() as $r) { ?>
                                    <tr>                                        
                                            <td align="center">
                                                <a href="?c=Operario&m=viewDetalleUsuario&id=<?php echo $r->usuario_id;?>">Ver<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                                                    <a href="?c=Operario&m=viewUpdateUsuario&id=<?php echo $r->usuario_id;?>">Modificar<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                                                    <?php if ($r->usuario_estado==1){?>
                                                    <a href="?c=Operario&m=desactivarUsuario&id=<?php echo $r->usuario_id;?>">Desactivar<span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                                                    <?php }  else { ?>
                                                      <a href="?c=Operario&m=activarUsuario&id=<?php echo $r->usuario_id;?>">Activar<span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>     
                                                       <?php } ?>
                                            </td>                                       
